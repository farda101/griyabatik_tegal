...
class UpdateJadwalWorkshopRequest extends FormRequest
{
    /**
    ...
    {
        // Hanya superadmin yang diizinkan untuk memperbarui jadwal workshop
    ...
    {
        // Parameter jadwal_workshop dari route model binding
        $jadwalWorkshop = $this->route('jadwal_workshop');

        return [
            'paket_workshop_id' => 'required|exists:paket_workshops,id',
            // Tanggal bisa sama dengan tanggal saat ini atau setelahnya jika diubah
