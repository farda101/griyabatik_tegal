...
class UpdateVideoRequest extends FormRequest
{
    ...
    {
        // Hanya superadmin yang diizinkan untuk memperbarui video
    ...
    public function rules(): array
    {
        return [
            ...
            'file_video' => 'nullable|file|mimes:mp4,mov,avi,wmv,flv,webm|max:500000', // Opsional saat update
            'thumbnail' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048', // Opsional saat update
            'durasi_detik' => 'required|integer|min:1',
            'is_active' => 'boolean',
        ];
    }
