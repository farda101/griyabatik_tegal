...
use Maatwebsite\Excel\Concerns\WithMultipleSheets; // Untuk banyak sheet (opsional, jika ingin ringkasan & detail)
use Maatwebsite\Excel\Concerns\ShouldAutoSize;     // Untuk auto-size kolom (opsional)
use Carbon\Carbon;

class PenjualanReportExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize
{
    protected $startDate;
    protected $endDate;
    ...
    */
    ...
    public function map($penjualan): array
    {
        ...
        return [
            ...
            implode("\n", $itemDetails), // Gabungkan detail item ke satu sel dengan baris baru
