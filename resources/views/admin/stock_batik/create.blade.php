                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        ...
                        <select name="motif" id="motif"
                            ...
                            <option value="Cempaka" {{ old('motif') == 'Cempaka' ? 'selected' : '' }}>Cempaka</option>
                            <option value="Gribigan" {{ old('motif') == 'Gribigan' ? 'selected' : '' }}>Gribigan</option>
                            <option value="Galaran" {{ old('motif') == 'Galaran' ? 'selected' : '' }}>Galaran</option>
                            <option value="Beras Mawur" {{ old('motif') == 'Beras Mawur' ? 'selected' : '' }}>Beras Mawur</option>
                            <option value="Mata Deruk" {{ old('motif') == 'Mata Deruk' ? 'selected' : '' }}>Mata Deruk</option>
                            <option value="Tumbar Bolong" {{ old('motif') == 'Tumbar Bolong' ? 'selected' : '' }}>Tumbar Bolong</option>
                            <option value="Kuku Macan" {{ old('motif') == 'Kuku Macan' ? 'selected' : '' }}>Kuku Macan</option>
                            <option value="Semut Runtung" {{ old('motif') == 'Semut Runtung' ? 'selected' : '' }}>Semut Runtung</option>
                            <option value="Benang Pedhot" {{ old('motif') == 'Benang Pedhot' ? 'selected' : '' }}>Benang Pedhot</option>
                        </select>
                        @error('motif')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
