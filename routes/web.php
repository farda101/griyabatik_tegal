...
use App\Http\Controllers\Admin\QrCodeRegeneratorController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:superadmin')->group(function () {
        ...
        // --- Rute untuk Laporan Keuangan (Pemasukan & Pengeluaran) ---
        Route::prefix('admin/laporan-keuangan')->name('admin.laporan_keuangan.')->group(function () {
            Route::get('/pemasukan', [LaporanKeuanganController::class, 'pemasukan'])->name('pemasukan');
            Route::get('/pemasukan/export', [LaporanKeuanganController::class, 'exportPemasukan'])->name('pemasukan.export');
            Route::get('/pengeluaran', [LaporanKeuanganController::class, 'pengeluaran'])->name('pengeluaran');
            Route::get('/pengeluaran/export', [LaporanKeuanganController::class, 'exportPengeluaran'])->name('pengeluaran.export');
        });
